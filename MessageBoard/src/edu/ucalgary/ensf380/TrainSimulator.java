...
public class TrainSimulator {
    ...
    public TrainSimulator(List<Station> stations, List<Train> trains, MapDisplay mapDisplay, Train currentTrain, String outputDir) {
        // Constructor to initialize the TrainSimulator
        this.trains = trains;
    ...
    public void startSimulation() {
        // Method to start the train simulation
    ...
    /**
     * Prints the current positions of the trains to the console and writes them to a file.
     */
